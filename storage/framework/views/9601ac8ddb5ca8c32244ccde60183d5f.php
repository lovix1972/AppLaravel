                ...
                <?php if(is_object($register)): ?>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $register; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($reg->idcapitolo); ?> </td>
                            ...
                            <td class="importi text-right"><?php echo e(number_format($reg->importo),2); ?> </td>
                            <td class="importi text-right"><?php echo e(number_format($reg->previstoimpegno),2); ?> </td>
                            <td class="importi text-right"><?php echo e(number_format($reg->impegnato),2); ?> </td>
                            <td class="importi text-right"><?php echo e(number_format($reg->contabilizzato),2); ?></td>
                        ...
                        <div class="modal-content px-5 m-2">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="number" class="form-control" id="idreparto" name="idreparto" value="<?php echo e($reg->idreparto); ?>" >
                                </div>
                                <div class="mb-2">
                                    <label for="numpds" class ="form-label">Num PDS</label>
...
unset($__errorArgs, $__bag); ?>" id="datapds" name="datapds" value="<?php echo e($reg->datapds); ?>" >
                            ...
                            <div class="container col-auto d-flex justify-start">
                                <div class="mb-2">
                                    ...
                                    <input type="number" class="form-control text-right" id="importo" name="importo" value="<?php echo e(number_format($reg->importo),2); ?>" required placeholder="0,00">
                                </div>
                                <div class="mb-2">
                                    <label for="previstoimpegno" class ="form-label">Previsto Impegno</label>
                                    <input type="number" class="form-control text-right" id="previstoimpegno" name="previstoimpegno" value="<?php echo e(number_format($reg->previstoimpegno),2); ?>"  required placeholder="0,00">
                                </div>
                                <div class="mb-2">
                                    <label for="impegnato" class ="form-label">Impegnato</label>
                                    <input type="number" class="form-control text-right" id="impegnato" name="impegnato" value="<?php echo e(number_format($reg->impegnato),2); ?>"  placeholder="0,00">
                                </div>
                                <div class="mb-2">
                                    <label for="contabilizzato" class ="form-label">Contabilizzato</label>
                                    <input type="number" class="form-control text-right" id="contabilizzato" name="contabilizzato" value="<?php echo e(number_format($reg->contabilizzato),2); ?>"  placeholder="0,00">
                                </div>
                            </div>
...
<?php /**PATH /home/lovix/PhpstormProjects/AppLaravel/resources/views/pages/modifica.blade.php ENDPATH**/ ?>