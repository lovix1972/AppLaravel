...
<?php $component->withAttributes([]); ?>
    <div>
                ...
                <table class="table table-hover table-bordered ">
                       ...
                       <?php if($register->isempty()): ?>
                        ...
                        <tbody>
                            ...
                            <td><?php echo e($reg->idreparto); ?> </td>
                            ...
                            <td><input type="button" onclick=window.location.href="/modifica/<?php echo e($reg->id); ?>" class="btn-primary btn-sm" value="Modifica" ></td>
                            <form>
                            <input type="hidden" name="_token" id="_token"  value="<?php echo e(csrf_token()); ?>">
                                <td> <a href="/inspds/<?php echo e($reg->id); ?>"><button class ="btn-danger btn-sm" id="btn-danger" title="delete" data-toggle="tooltip">Cancella</button></a>
        ...
        <td class="importi text-right"><?php echo e(number_format($register->sum('importo'),2,',','.')); ?></td>
        <td class="importi text-right"><?php echo e(number_format($register->sum('previstoimpegno'),2,',','.')); ?></td>
        <td class="importi text-right"><?php echo e(number_format($register->sum('impegnato'),2,',','.')); ?></td>
        <td class="importi text-right"><?php echo e(number_format($register->sum('contabilizzato'),2,',','.')); ?></td>
...
<?php /**PATH /home/lovix/PhpstormProjects/AppLaravel/resources/views/pages/reglist.blade.php ENDPATH**/ ?>