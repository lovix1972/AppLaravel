            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        <?php if(auth()->guard()->check()): ?>     <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                ...
                <div class="relative ml-3">
                    ...
                    <div>
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            <a href="#" class="dropdown-toggle rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white" data-toggle="dropdown" role="button" aria-expanded="false" style="color: white"><?php echo e(Auth::user()->name); ?></a>
                            <ul class="dropdown-menu" role="menu">
                            <li>
                                <a href="<?php echo e(route('logoutUser')); ?> " class="px-3 py-2 text-sm font-medium text-black" >Logout</a>
                                </li>
                           </ul>
                            <?php endif; ?>
                    </div>
