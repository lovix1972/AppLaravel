        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <p><strong>Programma:</strong> {{ $capitolo->prog }}</p>
                    <p><strong>IDV:</strong> {{ $capitolo->idv }}</p>
                    <p><strong>Decreto:</strong> {{ $capitolo->decreto }}</p>
                    <p><strong>Reparto:</strong> {{ optional($capitolo->department)->reparto }}</p>
                    <p><strong>Preavviso:</strong> {{ $capitolo->preavviso }}</p>
                    <p><strong>Anno:</strong> {{ $capitolo->anno }}</p>
