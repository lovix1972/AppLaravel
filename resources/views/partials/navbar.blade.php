...
@auth
            <ul
                ...
                <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
                    <a href='/dashboard'
                       class='hover:text-sky-400 text-amber-50 block font-semibold text-[15px]'>Dashboard</a>
                </li>

                    <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='/inspds'
                                                                                class='hover:text-sky-400 text-amber-50 block font-semibold text-[15px]'>Acquisizioni</a>
                </li>
                <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='#'
                                                                                class='hover:text-sky-400 text-amber-50 block font-semibold text-[15px]'>Gestione Finanziaria</a>
                </li>
                <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='javascript:void(0)'
                                                                                class='hover:text-sky-400 text-amber-50 block font-semibold text-[15px]'>Movimenti di Cassa</a>
                </li>
                <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='#'
                                                                                class='hover:text-sky-400 text-amber-50 block font-semibold text-[15px]'>Gestione Note</a>
                </li>
                <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='/reglist'
                                                                                class='hover:text-sky-400 text-amber-50 block font-semibold text-[15px]'>Registro</a>
                </li>
        ...
        <div class='flex max-lg:ml-auto space-x-4'>
            <a href="/logout"><button
                        class='px-4 py-2 text-sm rounded-full font-bold text-amber-50 border-2 bg-transparent hover:bg-gray-50 transition-all ease-in-out duration-300'>Logout</button></a>
            @endauth
            @guest
            <a href="/login"><button
                    class='px-4 py-2 text-sm rounded-full font-bold text-amber-50 border-2 bg-transparent hover:bg-gray-50 transition-all ease-in-out duration-300'>Login</button></a>
                <a href="/register"><button
                            class='px-4 py-2 text-sm rounded-full font-bold text-white border-2 border-[#007bff] bg-[#007bff] transition-all ease-in-out duration-300 hover:bg-transparent hover:text-[#007bff]'>Registrati</button></a>
